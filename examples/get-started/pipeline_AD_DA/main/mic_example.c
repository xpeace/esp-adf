...
#if defined CONFIG_ESP32_S2_KALUGA_1_V1_2_BOARD // || defined CONFIG_ESP32_AI_THINKER_V2_3_BOARD
...
//    audio_hal_ctrl_codec(board_handle->audio_hal, AUDIO_HAL_CODEC_MODE_LINE_IN, AUDIO_HAL_CTRL_START);
	...
	// i2s_cfg_read->adc_input = AUDIO_HAL_ADC_INPUT_LINE2;
    i2s_cfg_read.i2s_config.sample_rate = 48000;
    i2s_stream_reader = i2s_stream_init(&i2s_cfg_read);

    i2s_alc_volume_set(i2s_stream_reader, 32);
    ...
    while (1) {
        ...
        if (msg.cmd == AEL_MSG_CMD_ERROR ) {  // AEL_MSG_CMD_ERROR enum 1
